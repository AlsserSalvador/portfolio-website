...
let heroContainerBackground = document.querySelector('.hero-container-background')
let heroContainerImage = document.querySelector('.hero-container-image')


window.addEventListener('scroll', function(){
  heroContainerBackground.style.transform = `translateY(${ window.pageYOffset * 0.1}px)`
  heroContainerImage.style.transform = `translateY(${ window.pageYOffset * -0.1}px)`
})

// heroContainerImage.style.transform = `translateY(${ offsetY * -0.4}px)`
// heroContainerImage.style.transform = `translateY(${ offsetY * -0.4}px)`
